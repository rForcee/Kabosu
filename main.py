...
def add_player():
  ...
  if joueur == []:
    ...
    playerId = db.select("SELECT j_id FROM joueur WHERE j_pseudo = '" + name + "';")
    ...
    sqlInsertBoisson = "INSERT INTO boisson(b_nom, b_alcool, b_chaud, b_prixvente, b_prixprod, j_id) VALUES ('Limonade', 0,0,0,0.8, "+str(playerId)+"), ('The vert', 0,1,0,0.8, "+str(playerId)+"), ('Mojito',1,0,0,2, "+str(playerIid)+");"
    ...
    sql = sqlInsertJoueur + sqlInsertZone + sqlInsertBoisson + sqlInsertRecette
    db.execute(sql)
    db.close()
