...
def add_player():
  ...
  if joueur == []:
    ...
    sqlInsertBoisson = "INSERT INTO boisson(b_nom, b_alcool, b_chaud, b_prixvente, b_prixprod, j_id) VALUES ('Limonade', 0,0,0,0.8, "+str(id)+"), ('The vert', 0,1,0,0.8, "+str(id)+"), ('Mojito',1,0,0,2, "+str(id)+");"
